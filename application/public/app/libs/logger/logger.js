...
(function (factory) {
    ...
    $.Log = {
		...
		obj:function (obj) {
            ...
            if (this.level <= $.LogLevel.object && this.logEnabled) {
                console.log(obj);
            }
        },
        ...
        log:function (message) {
            ...
            if (this.level <= $.LogLevel.log && this.logEnabled) {
        ...
        info:function (message) {
            ...
            if (this.level <= $.LogLevel.info && this.logEnabled) {
        ...
        debug:function (message) {
            if (this.level <= $.LogLevel.debug && this.logEnabled) {
        ...
        error:function (message) {
            if (this.level <= $.LogLevel.error && this.logEnabled) {
        ...
        warn:function (message) {
            if (this.level <= $.LogLevel.warn && this.logEnabled) {
